...
vp.combined     <- viewport(layout.pos.col=1:3,layout.pos.row=4:6)
vp.wt           <- viewport(layout.pos.col=4:6,layout.pos.row=4:6)
vp.overall      <- viewport(layout.pos.col=7:9,layout.pos.row=4:6)
vp <- list(vp.deseq2,vp.splineTC,vp.maSigPro,vp.combined,vp.wt,vp.overall)
names(vp) = names(plotList) <- c("DESeq2","splineTC","maSigPro","pten+pik3ca","wt","pten+pik3ca_vs_wt")
