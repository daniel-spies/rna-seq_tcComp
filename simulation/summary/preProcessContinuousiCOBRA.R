...
methods <- methods[-grep("impulseDE$",methods)]
files <- sub(paste0(methods[1],".txt"),"",list.files(file.path(path,"results_noCutoff",methods[1]),pattern="*.txt")) # scan files of any of the folders
colHeading <- c("dynb"="score","EBSeqHMM"="score","FunPat"="P","impulseDE2"="P","maSigPro"="P","nsgp"="score","pairwise"="P","splineTC"="P","timeSeq"="P","lmms"="P")
