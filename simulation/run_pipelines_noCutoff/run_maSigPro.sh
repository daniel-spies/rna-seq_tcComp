...
Rscript --vanilla $scriptDir/maSigPro_multiTimeCourse.R $files ${dir}/results_noCutoff/maSigPro &
Rscript --vanilla $scriptDir/maSigPro_multiTimeCourse.R $dataDir/standard/${standard}_contr.txt ${dir}/results_noCutoff/maSigPro &